...
$number_of_records = NUMBER_OF_RECORDS; //maximum n A records with $name... 10 recommended
$user = USER; //user name
$key = KEY; //key for cloudflare api found in account settings
$seed_dump = SEED_DUMP; //absolute path to dnsseed.dump in the nubits-seeder root directory
